...
import DropAccount from "../LayOutComponents/DropAccount";
import img1 from "../../assets/Navbar/Logo.svg";
import ProfileCard from "../ComponentsNav/ProfileCard";
  ...
  return (
    <nav className="bg-white border-gray-200 z-1000 dark:bg-gray-900 shadow-md">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto px-4 py-3">
        <img src={img1} className="h-12" alt="Flowbite Logo" />
          ...
          <ul className="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
            ...
            <li className="flex items-center">
              <Link
                to="/flash-card-topic"
                className={`block py-2 px-3 rounded md:p-0 ${
                  location.pathname === "/flash-card-topic"
                    ? "text-white bg-blue-700 md:bg-transparent md:text-blue-700 md:dark:text-blue-500"
                    : "text-gray-900 hover:bg-gray-100 md:hover:bg-transparent md:hover:text-blue-700 dark:text-white md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent dark:border-gray-700"
                }`}
              >
            ...
            <li>
              <DropAccount onShowProfileCard={() => setShowProfileCard(true)} />
            </li>
          </ul>
        </div>
      </div>
